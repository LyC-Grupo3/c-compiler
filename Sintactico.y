...
funcion_read:
    READ PAR_A ID PAR_C                                 {
                                                            ...
                                                            t_simbolo *simbolo = buscarSimboloIDEnTablaSimbolo($3);
                                                            if(simbolo == NULL)
                                                            {
                                                                // LA FUNCION YA LA VALIDA ANTES, ASI QUE COMENTO ESTO PARA NO REPETIR MENSAJE
                                                                // printf("Error semántico: La variable '%s' no fue declarada.\n", $1);
                                                                // exit(1);
                                                            }
